<?php
/**
* @name information.class.php Service pour la récupératioarticlesrticles de la section A propos
* @author web-Projet.com (contact@web-projet.com) Juil. 2017
* @package App\Defaut\Index\information
* @version 1.0
**/
...
class Information {
	...
	protected function process(){
		...
		// Article Nouveautés
		$information = new \App\Mappers\Article\articlesStore();
		$data = $information->get("slug");
		$data->searchValue("newsletter");
		$clause = new \wp\Database\Mapper\clause($data);
		$clause->type("equal");
		$information->addClause($clause);

		$select = new \wp\Database\Query\select($information);

		$activeRecord = new \App\Mappers\Article\articlesActiveRecord($information);
	...
	protected function template(){
		...
		$templateName = "information" . \App\appLoader::$tpl->extension();
