<?php
/**
 * @name produitStore.class.php Service de mapping de données sur la structure de gestion des catégories
...
class produitStore extends \wp\Database\Mapper\dataStoreMapper {
