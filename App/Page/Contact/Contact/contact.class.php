<?php
/**
* @name contact.class.php Service pour la récupératioarticlesrticles de la section A propos
* @author web-Projet.com (contact@web-projet.com) Juil. 2017
* @package App\Defaut\Index\contact
* @version 1.0
**/
namespace App\Page\Contact\Contact;
...
class contact {
	...
	protected function process(){
		...
		$activeRecord = new \App\Mappers\Article\articlesActiveRecord($contact);
